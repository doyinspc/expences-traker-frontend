...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Expense vs Asset", path: "/finance/expense-asset" },
      { name: "Cash Flow", path: "/finance/cash-flow" },
      { name: "CAPEX", path: "/finance/capex" },
      { name: "OPEX", path: "/finance/opex" },
      { name: "Budget vs Actual", path: "/finance/budget-vs-actual", new: true },
      { name: "Budget Performance", path: "/finance/budget-performance" },
      { name: "Accounts & Banks", path: "/finance/accounts" },
    ],
  },
];
