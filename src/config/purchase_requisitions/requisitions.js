// src/config/purchaseRequisitions.js

const requisitions = {
    frontendRoutes: ['/procurement/requisitions'],
    description: 'Purchase requisitions initiated by employees',
    ...
    analysisConfig: {
        ...
        availableDimensions: ['department_id', 'requisition_type', 'status', 'priority', 'created_at'],
    },
    fields: {
        id: {
            label: 'PR Number',
            ...
            hidden: true,
            disabled: true,
            description: 'Auto-generated purchase requisition number',
            showInTable: true,
            tableWidth: '120px',
            filterable: true,
            filterType: 'text',
        ...
        title: {
            ...
            type: 'text',
            required: true,
            description: 'Brief title of the requisition',
            showInTable: true,
            showInForm: true,
            tableWidth: '200px',
            filterable: true,
        ...
        description: {
            ...
            type: 'textarea',
            description: 'Detailed description of the requisition',
            showInTable: false,
            showInForm: true,
            filterable: false,
            analyzable: false,
        ...
        requisition_type: {
            ...
            filterable: true,
            filterType: 'select',
            filterOptions: 'requisition_types',
            analyzable: true,
            analysisType: 'group',
            analysisGroup: 'type',
        },
        ...
        approver_id: {
            ...
            type: 'select',
            options: 'users',
            description: 'Person who approved this requisition',
            showInTable: false,
            showInForm: true,
            tableWidth: '150px',
            filterable: true,
        ...
        approve_date: {
            ...
            hidden: true,
            disabled: true,
            description: 'Date when the requisition was approved',
            showInTable: true,
            showInForm: true,
            tableWidth: '150px',
            filterable: true,
