// src/config/purchasePurchaseorders.js

const purchaseorders = {
    frontendRoutes: ['/procurement/purchaseorders'],
    description: 'Purchase purchaseorders initiated by employees',
    ...
    analysisConfig: {
        ...
        availableDimensions: ['department_id', 'purchaseorder_type', 'status', 'priority', 'created_at'],
    },
    fields: {
        id: {
            label: 'PR Number',
        ...
        title: {
            ...
            type: 'text',
            required: true,
            description: 'Brief title of the Purchase order',
            showInTable: true,
            showInForm: true,
            tableWidth: '200px',
            filterable: true,
        ...
        description: {
            label: 'Description',
            placeholder: 'Detailed description of Purchase Order',
            type: 'textarea',
            description: 'Detailed description of the Purchase Order',
            showInTable: false,
            showInForm: true,
            filterable: false,
            analyzable: false,
        ...
        purchaseorder_type: {
            label: 'Purchaseorder Type',
            placeholder: 'Select type',
            type: 'select',
            required: true,
            hidden: true,
            options: 'purchaseorder_types',
            description: 'Type of purchaseorder ',
            showInTable: true,
            showInForm: true,
            tableWidth: '140px',
            filterable: true,
            filterType: 'select',
            filterOptions: 'purchaseorder_types',
            analyzable: true,
            analysisType: 'group',
            analysisGroup: 'type',
        },
        ...
        status: {
            ...
            placeholder: 'draft',
            type: 'select',
            options: 'purchaseorder_status',
            description: 'Current status of the purchaseorder',
            showInTable: true,
            showInForm: true,
            tableWidth: '150px',
            filterable: true,
            filterType: 'select',
            filterOptions: 'purchaseorder_status',
            analyzable: true,
            analysisType: 'group',
        ...
        approver_id: {
            ...
            type: 'select',
            options: 'users',
            description: 'Person who approved this purchaseorder',
            showInTable: false,
            showInForm: true,
            tableWidth: '150px',
            filterable: true,
        ...
        approve_date: {
            ...
            hidden: true,
            disabled: true,
            description: 'Date when the purchaseorder was approved',
            showInTable: true,
            showInForm: true,
            tableWidth: '150px',
            filterable: true,
