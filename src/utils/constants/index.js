...
export const API_PATH_STUDENT = import.meta.env.VITE_API_URL;
export const API_PATH_STAFF = import.meta.env.VITE_API_URL;
...
export const MAIN_TOKEN = sessionStorage.getItem('token');
export const PICS = import.meta.env.VITE_REACT_APP_LOGO;
export const SCHOOLLOGO = import.meta.env.VITE_REACT_APP_LOGO;
export const SCHOOLMOTTO = import.meta.env.VITE_REACT_APP_MOTTO;
export const imgx = import.meta.env.VITE_REACT_APP_LOGO;
export const imgb = import.meta.env.VITE_REACT_APP_BG;
export const PAGETITLE = import.meta.env.VITE_REACT_APP_TITLE;
export const PAGEDESCRIPTION = "Best School in Town";
...
export const userRoles = [
  { id: 2, name: 'Staff Access' },
  { id: 3, name: 'Administrator/Management' },
  { id: 4, name: 'Account' },
];
