...
import IncomeItemForm from "./IncomeItemForm.jsx";
...
import { AddIcon, BackIcon, FilterIcon, InfoIcon, ReloadIcon } from '../../components/ui/TableIcons.js';
...
const table_data = [
    ...
    {label: 'TID', name:'requisition_id', type:'number', showTable: false, editable:false, element:null},
    {label: 'Transaction Number', name:'pr_id', type:'text', showTable: true, editable:false, element:null},
    ...
    {label: 'Total Price', name:'credit_price', type:'number', showTable: true, editable:false, element:null, format:(e)=>numberFunction(e)},
    ...
    // Audit
    {label: 'Start Date', name:'created_at', type:'datetime', showTable: true, editable:false, element:null},
...
const Requisitions: React.FC = () => {
    ...
    const { data, loadQuery, loadUpdate, isLoading } = useReduxApiData({
        table: TABLE_NAME,
        uniqueKey: 'requisitionitem',
        queryType: 'gets',
        mainParam: { requisition_id: requisition_id || 0 },
        narration: 'get all income item'
    });
